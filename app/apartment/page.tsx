...
const features: Array<{ icon: LucideIcon; title: string; body: string }> = [
  ...
  },
  {
    icon: QrCode,
    title: "쿠폰/QR 인증",
    body: "업체는 쿠폰 유효 여부만 확인하고 개인정보는 확인하지 않는 구조",
  },
  {
    icon: ClipboardCheck,
    title: "관리자 리포트",
...
const faqs = [
  ...
  },
  {
    ...
    a: "입주민 정보는 인증과 서비스 이용 목적에 한해 사용되며, 제휴업체에는 동호수와 연락처 등 개인정보가 제공되지 않습니다. 업체는 쿠폰 유효 여부만 확인합니다.",
  },
  {
    q: "특정 업체 특혜 논란은 없나요?",
        ...
        <div className="container-pad grid gap-10 py-16 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-cream-200/90 sm:text-base">
              ...
              혜택을 이용할 수 있습니다. 제휴업체는 쿠폰 유효 여부만 확인하며,
        ...
        <div className="container-pad grid gap-10 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <SectionHeader
              ...
              description="현재 구현된 복지몰은 입주민 인증을 기준으로 혜택 상세, 쿠폰, 공동구매 신청 권한을 구분합니다."
            />
